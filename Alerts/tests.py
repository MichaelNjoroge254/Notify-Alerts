...
class TestBusiness(TestCase):
  def setUp(self):
    ...
    self.hood = Neighborhood.objects.create(name='Kisumu Ndogo', location=self.location, policehelpline=2, hospitalhelpline=2, occupants=8)
    self.business = Business.objects.create(businessname = 'trial1', description='description for trial1', email='michael.njoroge@student.moringaschool.com', username=self.newuser, neighborhood=self.hood)
  ...
  def test_save_business(self):
    self.business2 = Business.objects.create(businessname = 'trial2', description='description for trial2', email='michael.njoroge@student.moringaschool.com', username=self.newuser, neighborhood=self.hood)
